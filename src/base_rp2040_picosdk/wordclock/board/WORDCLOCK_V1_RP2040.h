...
#define HWPCBV1_JP3_CLOSED
#ifdef HWPCBV1_JP3_CLOSED
#define PICO_DEFAULT_WS2812_OFFSET 1
#else
#define PICO_DEFAULT_WS2812_OFFSET 0
#endif

#define PICO_DEFAULT_WS2812_NUM ((10*11)+4 + PICO_DEFAULT_WS2812_OFFSET) // + 4 minute leds 
