...
#define WORDCLOCK_BRIGHTNESS_MODE_AUTO_MIN 50  //IF IN AUTOMODE LED MIN BRIGHTNESS
...
//#define FORCE_BH1750
//#define DISBALE_BH1750
#define USE_WIFIINTERFACE_SETTINGS //USE CONFIG SETTINGS FROM WIFIINTERFACE, NEW ENTRIES MUST BE DECLARED IN WIFI INTERFACE
#define FLASH_CHECK_VALUE_START 43 //USED AS MARKER VALUE TO INDICATE IF THE FLASH/EEPROM WAS USED BY A OTHER FW VERSION
