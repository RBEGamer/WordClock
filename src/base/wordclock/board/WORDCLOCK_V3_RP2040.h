...
#ifndef _BOARDS_WORDCLOCK_V3_RP2040_H
#define _BOARDS_WORDCLOCK_V3_RP2040_H
...
// For board detection
    ...
    #define WORDCLOCK_PCBREV 3 //1=PCBv1 2=PCBv2 3=PCBv3
#endif
//----------- DEFAULT SETTINGS ---------------------------------------//
...
#define WORDCLOCK_COLOR_MODE 0 //see wordclock_faceplate.hpp 0=rainbow 1=separate 2=white cold 3=white warm
#define WORDCLOCK_DAYLIGHTSAVING 1 //ENABLE EU DAYLIGHT SAVING

//------ SETTINGS FOR ENGLISH FONTFACE ------------ //
// DEPENDING ON THE FONTFACE DISPLAY AM/PM. THERE ARE SOME FONTFACES WITH AM/PM IN THE TOP RIGHT CORNER
//#define WORDCLOCK_ENGLISH_FONTFACE_ENABLE_AM_PM
//------------------------------------------------ //
//--------------------------------------------------------------------//


// CUSTOM PCB COMPONENTS
#if WORDCLOCK_PCBREV <= 1
    ...
    #define USE_FLASH_AS_EEPROM //PCB v1 IS MISSING THE EEPROM SO  WE USE THE RP2040 FLASH
#endif
...
#if WORDCLOCK_PCBREV >= 2
    #define USE_EEPROM_IF_PRESENT //PCB v2 OFFERS A M24C02 I2C EEPROM IF THIS IS PRESENT USE THIS TO STORE CONFIG
#endif
...
#if WORDCLOCK_PCBREV >= 3
    #define ENABLE_AUTOMATIC_FACEPLACE_DETECTION // IF PCF8574_I2C_ADDR FOUND USE P0-P3 TO DETECT FACEPLATE USING MAGNETS
#endif

// SINCE PCBv3 THE ESP BOOT AND RST LINES ARE DIRECTLY CONNECTED TO THE RP2040
// SO IT IS POSSIBLE TO FLASH THE FIRMWARE OF THE ESP USING THE RP2040
// THE FIRMWARE IST STORED IN THE firmware_data.hpp file
#if WORDCLOCK_PCBREV >= 3
    #define INCLUDE_ESP_FIRMWARE //ONLY SUPPORTED IN V3
...
#define PCF8574_I2C_ADDR 0x38 //IN V3 ADDED PCF8574
...
// PCBv2 = 0,PCBv1 = 1 (on pcb v1 there is an additional led before the first matrix led)
#if WORDCLOCK_PCBREV <= 1
    #define LED_MATRIX_START_OFFSET 1 
#else
    #define LED_MATRIX_START_OFFSET 0
#endif
