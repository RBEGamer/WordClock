...
// THE USE_EEPROM_IF_EEPROM_IS_PRESENT IS SET OPTION CAN OVERRIDE THIS, SO FLASH IS FALLBACK!
// PLEASE NOTE: SET PICO_FLASH_SIZE_BYTES (see below) CORRECTLY
#define USE_FLASH_AS_EEPROM
//#define USE_EEPROM_IF_EEPROM_IS_PRESENT

#define USE_WIFIINTERFACE_SETTINGS //USE CONFIG SETTINGS FROM WIFIINTERFACE, NEW ENTRIES MUST BE DECLARED IN WIFI_INTERFACE.H
