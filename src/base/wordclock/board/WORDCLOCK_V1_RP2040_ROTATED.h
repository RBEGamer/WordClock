...
#define WORDCLOC_BRIGHTNESS_MODE_AUTO_MIN 50  //IF IN AUTOMODE LED MIN BRIGHTNESS
#define WORDCLOC_BRIGHTNESS_MODE_AUTO_MAX 200 //IF IN AUTOMODE LED MAXBRIGHTNESS
#define WORDCLOC_BRIGHTNESS_MODE_AUTO_CURVE 1.5 // FLOAT FOR BRIGHTNESS CURVE
