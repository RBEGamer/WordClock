...
void handleRoot()
{
    ...
    control_forms += "<br><h3> CLOCK CONTROLS </h3>"
                     ...
                     "</form><br>";
    // FONTFACE
    control_forms += "<form name='btn_on' action='/save' method='GET' required ><select name='sfp' id='sfp'><option value='0'>GERMAN</option><option value='1'>ENGLISH</option><option value='2'>BINARY</option><option value='3'>DOTS</option></select><input type='submit' value='SAVE'/></form><br>";
    //FLIP DISPLAY
    control_forms += "<form name='btn_on' action='/save' method='GET' required ><select name='sdo' id='sdo'><option value='0'>NORMAL</option><option value='1'>ROTATED</option></select><input type='submit' value='SAVE'/></form><br>";
    // DAYLIGHTSAVING
    control_forms += "<form name='btn_on' action='/save' method='GET' required ><select name='dls' id='dls'><option value='0'>DISBALED</option><option value='1'>ENABLED</option></select><input type='submit' value='SAVE'/></form><br>";         
   //BRIGHTNESS
    control_forms += "<form name='btn_off' action='/save' method='GET'<input type='number' name='sb' id='sb' min='0' max='255' required placeholder='0=AUTO'/><input type='submit' value='SET BRIGHTNESS'/></form><br>";
    //BRIGHTNESS
    control_forms += "<form name='btn_off' action='/save' method='GET'<input type='number' name='sbc' id='sbc' min='0' max='100' required placeholder='0=AUTO'/><input type='submit' value='SET BRIGHTNESS'/></form><br>";
